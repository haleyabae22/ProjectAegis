        ...
        <View style={heroStyles.centre}>
          ...
          <View style={heroStyles.heroContentGroup}>
            ...
            <Pressable
              style={(state) => [
                heroStyles.button,
                isStartHovered && heroStyles.buttonHover,
                state.pressed && heroStyles.buttonPressed,
              ]}
              onHoverIn={() => setIsStartHovered(true)}
              onHoverOut={() => setIsStartHovered(false)}
          ...
          <View style={styles.modalCard}>
            ...
            <View style={styles.choiceRow}>
              <Pressable
                style={(state) => [
                  styles.choiceButton,
                  (state as any).hovered && styles.choiceButtonHover,
                  citizenship === "Yes" && styles.choiceButtonActive,
                  (state as any).hovered && citizenship === "Yes" && styles.choiceButtonActiveHover,
                ]}
              ...
              <Pressable
                style={(state) => [
                  ...
                  (state as any).hovered && citizenship === "No" && styles.choiceButtonActiveHover,
                ]}
            ...
            <View style={styles.modalActions}>
              <Pressable
                style={[styles.ghostButton, isCancelHovered && styles.ghostButtonHover]}
              ...
              <Pressable
                style={[
                  styles.submitButton,
                  isSubmitHovered && canSubmit && styles.submitButtonHover,
